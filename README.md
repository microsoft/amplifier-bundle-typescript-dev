...
Comprehensive TypeScript/JavaScript development tools for [Amplifier](https://github.com/microsoft/amplifier).
...
# Quality tools only:
includes:
  - bundle: typescript-dev:behaviors/typescript-quality
```
